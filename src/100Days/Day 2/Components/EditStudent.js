...
const EditStudent = () => {
  ...
  const { id } = useParams();
  const std = useSelector((state) => state.student.student);

  const [newStd, setnewStd] = useState(std);
  console.log(std, newStd);
  const handleAddData = (e) => {
    e.preventDefault();
    dispatch(updateStudent(newStd));
    nav("/");
  };
        ...
        >
          <div class="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setnewStd({ ...newStd, firstName: e.target.value })
              }
            />
          </div>
          <div class="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setnewStd({ ...newStd, lastName: e.target.value })
              }
            />
          </div>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setnewStd({ ...newStd, address: e.target.value })
              }
            />
          </div>
          <div class="mb-4">
